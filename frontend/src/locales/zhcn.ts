export default {
  ...
  setting: {
    ...
    update: "自动更新时间",
    subUri: "订阅 URI",
    subApiKey: "聚合订阅 API 密钥",
    subApiKeyHint: "留空则聚合订阅接口不鉴权",
    subApiPath: "聚合订阅路径",
    subApiPathHint: "聚合订阅接口的自定义路径（默认随机，防止被扫描）；修改后需重启订阅服务生效",
    jsonSub: "JSON 订阅",
    toDirect: "路由到直连",
    toBlock: "路由到阻止",
    timestamp: "时间戳",
  ...
  client: {
    ...
    dynamicLimitEnabled: "动态下载限速",
    dynamicLimitThreshold: "下载触发阈值",
    dynamicLimitDuration: "连续触发时长",
    dynamicLimitRate: "触发后下载限速",
    dynamicLimitCooldown: "限速持续时长",
    dynamicDisabled: "动态：未启用",
    dynamicObserving: "动态：观察中",
    dynamicLimited: "动态：限速中，剩余",
  },
  bulk: {
    order: "排序",
    random: "随机",
    ...
    batchInput: "批量输入（每行一个：ip:port:username:password）",
    parsedCount: "已解析 {count} 行",
    parseError: "{bad} 行格式无效（应为 ip:port:username:password）",
    countMismatch: "行数（{lines}）与选中出站数（{items}）不匹配",
  },
  types: {
    un: "用户名",
    pw: "密码",
  ...
  rule: {
    ...
    import: {
      ...
      importPartial: '导入 {added} 条，跳过 {skipped} 条（用户已被占用）。',
      importAllSkipped: '全部 {count} 条因用户冲突被跳过。',
    },
  },
  ruleset: {
    add: "添加规则集",
  ...
  stats: {
    topUsers: "流量排行",
    topUsersSubtitle: "近 24 小时流量 Top 10",
    upload: "上传",
    download: "下载",
    volume: "流量",
    usage: "已用",
