export default {
  ...
  setting: {
    ...
    subApiKeyHint: "Leave empty to disable auth on the batch subscription API",
    subApiPath: "Batch Subscription Path",
    subApiPathHint: "Custom path for the batch subscription API (random by default, prevents scanning); takes effect after sub service restart",
  ...
  client: {
    ...
    dynamicLimitEnabled: "Dynamic Download Limit",
    dynamicLimitThreshold: "Trigger Threshold",
    dynamicLimitDuration: "Trigger Duration",
    dynamicLimitRate: "Limited Download Rate",
    dynamicLimitCooldown: "Limit Duration",
    dynamicDisabled: "Dynamic: disabled",
    dynamicObserving: "Dynamic: observing",
    dynamicLimited: "Dynamic: limited, remaining",
  },
  bulk: {
    order: "Order",
    random: "Random",
