export default {
  ...
  setting: {
    ...
    subApiKeyHint: "برای غیرفعال‌کردن احراز هویت API اشتراک تجمیعی خالی بگذارید",
    subApiPath: "مسیر اشتراک تجمیعی",
    subApiPathHint: "مسیر سفارشی برای API اشتراک تجمیعی (به‌صورت پیش‌فرض تصادفی، جلوگیری از اسکن)؛ پس از راه‌اندازی مجدد سرویس اشتراک اعمال می‌شود",
  ...
  client: {
    ...
    dynamicLimitEnabled: "محدودیت پویای دانلود",
    dynamicLimitThreshold: "آستانه فعال‌سازی",
    dynamicLimitDuration: "مدت فعال‌سازی",
    dynamicLimitRate: "سرعت محدود دانلود",
    dynamicLimitCooldown: "مدت محدودیت",
    dynamicDisabled: "پویا: غیرفعال",
    dynamicObserving: "پویا: در حال بررسی",
    dynamicLimited: "پویا: محدود، باقی‌مانده",
  },
  bulk: {
    order: "ترتیب",
    random: "تصادفی",
