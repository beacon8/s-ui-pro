export default {
  ...
  setting: {
    ...
    subApiKeyHint: "Để trống để tắt xác thực API đăng ký gộp",
    subApiPath: "Đường dẫn Đăng ký gộp",
    subApiPathHint: "Đường dẫn tùy chỉnh cho API đăng ký gộp (ngẫu nhiên theo mặc định, chống quét); có hiệu lực sau khi khởi động lại dịch vụ đăng ký",
  ...
  client: {
    ...
    dynamicLimitEnabled: "Giới hạn tải xuống động",
    dynamicLimitThreshold: "Ngưỡng kích hoạt",
    dynamicLimitDuration: "Thời gian kích hoạt",
    dynamicLimitRate: "Tốc độ tải xuống giới hạn",
    dynamicLimitCooldown: "Thời gian giới hạn",
    dynamicDisabled: "Động: tắt",
    dynamicObserving: "Động: đang theo dõi",
    dynamicLimited: "Động: đang giới hạn, còn",
  },
  bulk: {
    order: "Sắp xếp",
    random: "Ngẫu nhiên",
