export default {
  ...
  setting: {
    ...
    subApiKeyHint: "Оставьте пустым, чтобы отключить аутентификацию API агрегированной подписки",
    subApiPath: "Путь агрегированной подписки",
    subApiPathHint: "Пользовательский путь для API агрегированной подписки (по умолчанию случайный, защита от сканирования); вступает в силу после перезапуска службы подписки",
