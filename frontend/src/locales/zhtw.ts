export default {
  ...
  setting: {
    ...
    subApiKeyHint: "留空則聚合訂閱介面不鑑權",
    subApiPath: "聚合訂閱路徑",
    subApiPathHint: "聚合訂閱介面的自訂路徑（預設隨機，防止被掃描）；修改後需重啟訂閱服務生效",
    jsonSub: "JSON 訂閱",
    toDirect: "路由到直連",
    toBlock: "路由到阻止",
    timestamp: "時間戳",
  ...
  client: {
    ...
    dynamicLimitEnabled: "動態下載限速",
    dynamicLimitThreshold: "下載觸發閾值",
    dynamicLimitDuration: "連續觸發時長",
    dynamicLimitRate: "觸發後下載限速",
    dynamicLimitCooldown: "限速持續時長",
    dynamicDisabled: "動態：未啟用",
    dynamicObserving: "動態：觀察中",
    dynamicLimited: "動態：限速中，剩餘",
  },
  bulk: {
    order: "排序",
    random: "隨機",
